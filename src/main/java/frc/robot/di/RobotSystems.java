...
public class RobotSystems {
    ...
    @Provides
    @Singleton
    RollerSubsystem provideRollerSubsystem(LimelightSystem limelightSystem, CommandSwerveDrivetrain drivetrain) {
        return new RollerSubsystem(limelightSystem, drivetrain);
    }
